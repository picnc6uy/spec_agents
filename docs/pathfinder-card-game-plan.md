...
**Status:** draft for operator review, written before the engine code was visible; re-estimate P0 once the repo is attached. Operator confirmed 2026-09-16 the project is a game and already exists. · **Date:** 2026-09-16 · **Branch:**
